...
public class ListViewAdapter_forLegoItem extends BaseAdapter{
	Context context;
	List<LegoItem> listItems;
	LayoutInflater listContainter;
	
	public ListViewAdapter_forLegoItem(Context context, List<LegoItem> listItems)
	{
		super();
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		LegoItem cur = listItems.get(arg0);
